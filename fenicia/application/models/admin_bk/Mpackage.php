...
class Mpackage extends CI_Model {
	...
	public function get_pck_member_list($pck){
        ...
        CONCAT(mu.title,' ',mu.first_name,' ',ifnull(mu.middle_name,''),' ',mu.last_name) as full_name from master_member mu left join master_package pck on mu.member_type = pck.package_id
