...
class Member extends MY_Controller {
	...
	public function index($user_type=null) { 
        ...
        //echo $user_type; 
        $result['member_active_list'] 	= $this->mmember->get_member_list('1',$user_type,$start_date,$end_date);
		$result['member_inactive_list'] = $this->mmember->get_member_list('0',$user_type,$start_date,$end_date);
		/////////////////////////////////////////////////////
		//$result['member_active_list'] 	= $this->mmember->get_member_list('1',$user_type);
		//$result['member_inactive_list'] = $this->mmember->get_member_list('0',$user_type);
		//pr($data);		
