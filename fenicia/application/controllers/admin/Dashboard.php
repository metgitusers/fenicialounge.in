...
class Dashboard extends MY_Controller {
	...
	public function index() { 
		...
		$condition_user['is_delete'] = "0";
		$total_users_count=$this->mcommon->getNumRows("master_member",$condition_user);
		//echo $this->db->last_query();
		$data['total_users_count'] 				= $total_users_count;
		//app registered users count
		$condition_user['added_form'] = 'front';
		$app_users_count=$this->mcommon->getNumRows("master_member",$condition_user);
		//echo $this->db->last_query();die;
		$data['app_users_count'] 				= $app_users_count;
		//** new code end**//
