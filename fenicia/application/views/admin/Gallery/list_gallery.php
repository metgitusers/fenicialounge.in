                                                                    ...
                                                                    <table class="table table-striped table-bordered dom-jQuery-events c_table_style">
                                                                        ...
                                                                        <tbody>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><?= $actv_glly['gallery_sub_title'] ?></td>
                                                                                        ...
                                                                                        <td class="action_td text-center">
                                                                                            <a title="Log" class="btn_action edit_icon log_view" data-column="gallery_id" data-title="Gallery" data-id="<?= $actv_glly['gallery_id'];?>"><i class="fa fa-list" aria-hidden="true"></i></a>
                                                                                        </td>
                                                                                    </tr>
                                                                                <?php 
                                                                                } } else { ?>
                                                                    ...
                                                                    <table class="table table-striped table-bordered dom-jQuery-events c_table_style">
                                                                        ...
                                                                        <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><?= $inactv_glly['gallery_sub_title'] ?></td>
                                                                                    ...
                                                                                    <td class="action_td text-center">
                                                                                        <a title="Log" class="btn_action edit_icon log_view" data-column="gallery_id" data-title="Gallery" data-id="<?= $inactv_glly['gallery_id'];?>"><i class="fa fa-list" aria-hidden="true"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <?php 
                                                                                } } else { ?>
