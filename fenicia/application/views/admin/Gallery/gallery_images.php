                ...
                <div class="card-body">
                  <div class="card-block my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                    <div class="grid-hover">
                      ...
                      <?php     else:?>
                      <?php       $video_filename     = explode('.',$img_list['gallery_image']); ?>
                      <?php       $length             = count($video_filename)-1; ?>
                      <?php       $extention          = $video_filename[$length]; ?>
                                  <div class="col-md-4">
                                    <figure class="effect-julia">
                                      <a href="<?php echo base_url().'public/upload_image/gallery/'.$img_list['gallery_image'];?>" data-fancybox data-caption="<?php if(!empty($event_list)): echo $event_list['event_name']; endif;?>">
                                        ...
                                        <video width="100%" height="370px" controls><source src="<?php echo base_url().'public/upload_image/gallery/'.$img_list['gallery_image'];?>" type="video/<?php echo $extention; ?>"></video>                                            
                                      </a>                              
                                    </figure>
                                  </div>           
                      <?php     endif;?>
