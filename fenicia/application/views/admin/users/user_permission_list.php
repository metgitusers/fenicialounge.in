...
$(document).on('click','.save_actn',function(e){  
  e.preventDefault();   
   ...
   if($("#view_actn_"+menu_id).is(':checked'))
   {
      view_acn = '1';
   }
   else{
   ...
   $.ajax({
            ...
            data: {parent_id:parent_id,menu_id: menu_id,menu_name: menu_name,role_id:role_id,add:add,edit:edit,view_acn:view_acn,download:download,permission_id:permission_id},
            dataType:'JSON',
            success: function(response){                 
