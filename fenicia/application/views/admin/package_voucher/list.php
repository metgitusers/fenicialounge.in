																			...
																			<?php if (!empty($package_voucher_active_list)) { ?>
																				<?php foreach ($package_voucher_active_list as $key => $voucher_active) { ?>
																					<tr>
																						...
																						<td class="action_td text-center"><a title="Log" class="btn_action edit_icon log_view" data-column="package_voucher_id" data-title="Package Voucher" data-id="<?= $voucher_active['package_voucher_id'];?>"><i class="fa fa-list" aria-hidden="true"></i></a></td>
																					</tr>
																			...
																			<?php if (!empty($package_voucher_inactive_list)) { ?>
																				<?php foreach ($package_voucher_inactive_list as $key => $voucher_inactive) { ?>
																					<tr>
																						...
																						<td class="action_td text-center"><a title="Log" class="btn_action edit_icon log_view" data-column="package_voucher_id" data-title="Package Voucher" data-id="<?= $voucher_inactive['package_voucher_id'];?>"><i class="fa fa-list" aria-hidden="true"></i></a></td>
																					</tr>
