                    ...
                    <div class="card-body">
                        <div class="card-block pt-2 pb-0">
                            <div class="media justify-content">
                                <a href="<?php echo base_url().'admin/member/index/App';?>">
                                    <div class="media-body white text-left">
                                        <h4 class="font-medium-5 card-title mb-0"><u><?php echo $app_users_count; ?></u></h4>
                                         <span class="grey darken-1">App Registered Users</span>
                                    </div>
                                </a>
                        ...
                        <div class="card-block pt-2 pb-0">
                            <div class="media justify-content">
                                <a href="<?php echo base_url().'admin/member';?>"><div class="media-body white text-left">
                                    <h4 class="font-medium-5 card-title mb-0"><u><?php echo $total_users_count; ?></u></h4>
