				...
				<?php if(!empty($leftmenu)): ?>
					<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
						...
						<?php if(!empty($val['sub_menu']) || $val['menu_link'] !=''): ?>
							<li class="<?php echo $has_submenu_class;?> nav-item <?php echo $active_class.$open_class;?>"><a href="<?php if(!empty($val['menu_link'])): echo base_url($val['menu_link']); else: echo 'javascript:void(0)'; endif; ?>"><?php echo $val['menu_icon']; ?><span data-i18n="" class="menu-title"><?php echo $val['menu_name']; ?></span></a>
								<ul class="menu-content">
									<?php if(!empty($val['sub_menu'])): 
										...
										?>									
												<li class="<?php echo $sub_active_class; ?>"><a href="<?php if(!empty($sub_list['menu_link'])): echo base_url($sub_list['menu_link']); else: 'javascript:void(0)'; endif; ?>" class="menu-item"><?php echo $sub_list['menu_name']; ?></a></li>
									<?php endforeach; ?>
								<?php endif; ?>
								</ul>								
							</li>
						...
						<div class="navbar-container">							
							<div id="navbarSupportedContent" class="collapse navbar-collapse">
								<ul class="navbar-nav">	
									...
									<li><a class="add_bttn btn btn-success" href="<?php echo base_url().'admin/member/add'?>">New Club Membership</a></li>
