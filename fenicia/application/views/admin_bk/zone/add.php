                      	...
                      	<div class="form-body">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="number" min='1' class="form-control" name="minimum_capacity">
                              </div>
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="number" min='1' class="form-control" name="maximum_capacity">
                              </div>
                        ...
                        <div class="form-body">
                          <div class="row">                           
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                  <label>Minimum Capacity</label>
                                  <input type="number" min='0' class="form-control" value="<?php echo $zone['minimum_capacity'];?>" name="minimum_capacity">
                              </div>
                              <?php echo form_error('minimum_capacity', '<div class="error">', '</div>'); ?>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                                  <label>Maximum Capacity</label>
                                  <input type="number" min='0' class="form-control" value="<?php echo $zone['maximum_capacity'];?>" name="maximum_capacity">
                              </div>
                              <?php echo form_error('maximum_capacity', '<div class="error">', '</div>'); ?>
                            </div>
                            <div class="col-md-4">
