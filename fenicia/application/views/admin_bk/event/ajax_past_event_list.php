            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action_td text-center" width="18%">                                                                                            
                            <a title="Edit" style="width:auto; height:auto;" href="<?=base_url('admin/event/viewPastEventImages/'.$actv_ent['event_id'])?>" class="view_bttn btn_action edit_icon"><i class="fa fa-eye" aria-hidden="true"></i>View Event Images</a>
                        </td>
